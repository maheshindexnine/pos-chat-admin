...
const handleRegister = async () => {
  // Validate form
  if (!registerForm.name || !registerForm.email || !registerForm.password || !registerForm.organizationName) {
    ...
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        <img 
          ...
          alt="Logo" 
        />
        <h2 class="mt-6 text-3xl font-extrabold text-gray-900">Create new organization</h2>
